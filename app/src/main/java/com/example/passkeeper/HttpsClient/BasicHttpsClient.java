...
public class BasicHttpsClient implements HttpClient{
    ...
    private HttpResponse request(HttpRequest httpRequest) throws RequestException {
    ...
    public HttpResponse get(String url, HttpParameter[] httpParameters) throws RequestException {
        return request(new HttpRequest(RequestMethod.GET, url, httpParameters, this.requestHeaders, null));
    }

    public HttpResponse get(String url, HttpParameter[] httpParameters, Map<String, String> requestHeaders) throws RequestException {
        return request(new HttpRequest(RequestMethod.GET, url, httpParameters, requestHeaders, null));
    }

    public HttpResponse post(String url) throws RequestException {
        return request(new HttpRequest(RequestMethod.POST, url, null, null, null));
    }

    public HttpResponse post(String url, HttpParameter[] httpParameters) throws RequestException {
        return request(new HttpRequest(RequestMethod.POST, url, httpParameters, null, null));
    }

    public HttpResponse post(String url, HttpParameter[] httpParameters, Map<String, String> requestHeaders) throws RequestException {
        return request(new HttpRequest(RequestMethod.POST, url, httpParameters, requestHeaders, null));
    }

    public HttpResponse post(String url, HttpParameter[] httpParameters, Map<String, String> requestHeaders, String body) throws RequestException {
        return request(new HttpRequest(RequestMethod.POST, url, httpParameters, requestHeaders, body));
    }

    public HttpResponse put(String url) throws RequestException {
        return request(new HttpRequest(RequestMethod.PUT, url, null, null, null));
    }

    public HttpResponse put(String url, HttpParameter[] httpParameters) throws RequestException {
        return request(new HttpRequest(RequestMethod.PUT, url, httpParameters, null, null));
    }

    public HttpResponse put(String url, HttpParameter[] httpParameters, Map<String, String> requestHeaders) throws RequestException {
        return request(new HttpRequest(RequestMethod.PUT, url, httpParameters, requestHeaders, null));
    }

    public HttpResponse put(String url, HttpParameter[] httpParameters, Map<String, String> requestHeaders, String body) throws RequestException {
    ...
    public HttpResponse delete(String url, HttpParameter[] httpParameters) throws RequestException {
        return request(new HttpRequest(RequestMethod.DELETE, url, httpParameters, null, null));
    }

    public HttpResponse delete(String url, HttpParameter[] httpParameters, Map<String, String> requestHeaders) throws RequestException {
